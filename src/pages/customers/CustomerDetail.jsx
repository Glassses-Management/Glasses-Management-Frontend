...
const cardTitleClass = 'text-base font-semibold text-gray-900'
const cardLinkClass = 'text-sm font-medium text-violet-600 hover:text-violet-700'
          ...
          <div className={cardClass}>
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                <h2 className="truncate text-lg font-bold text-gray-900">{customer.name}</h2>
                <p className="text-sm text-gray-500">{deriveMemberId(customer.id)}</p>
                <p className="text-xs text-gray-400">Member since {memberSince(customer.createdAt)}</p>
              </div>
            </div>
        ...
        <div className="space-y-6 lg:col-span-7">
          <div className={cardClass}>
            ...
            {currentPrescription ? (
                ...
                <table className="mt-4 w-full text-sm">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-100">
                      <td className="py-3 font-semibold text-gray-900">OD</td>
                    ...
                    <tr>
                      <td className="py-3 font-semibold text-gray-900">OS</td>
              ...
              <p className="mt-4 text-sm text-gray-500">No prescription on record.</p>
            )}
          </div>
                ...
                {orderItems.map((item, i) => (
                  <li key={`${item.order.id}-${item.id}-${i}`} className="flex items-center gap-4 py-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className="truncate font-medium text-gray-900">{frameName(item.product)}</p>
                      <p className="truncate text-xs text-gray-500">{frameDescription(item)}</p>
                    </div>
                ...
                {appointments.map((appt) => (
                  <li key={appt.id} className="flex items-start justify-between gap-4 py-3">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="min-w-0">
                        <p className="font-medium text-gray-900">{appt.notes || 'Consultation'}</p>
