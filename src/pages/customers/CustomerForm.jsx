...
function CustomerForm() {
  ...
  const goBack = isEdit ? `/customers/${existing.id}` : '/customers'
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <nav className="flex items-center gap-2 text-sm text-gray-500">
        <Link to="/customers" className="group inline-flex items-center gap-1.5 font-medium transition-colors hover:text-gray-700">
