...
function MapPlaceholder() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          'linear-gradient(rgba(143,168,143,0.12) 1px, transparent 1px), linear-gradient(90deg, rgba(143,168,143,0.12) 1px, transparent 1px), linear-gradient(#F4F1EA, #F4F1EA)',
        backgroundSize: '34px 34px, 34px 34px, auto',
      }}
    >
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <span className="flex size-14 items-center justify-center rounded-full bg-[#8fa88f] text-white shadow-lg ring-8 ring-[#8fa88f]/15">
          <MapPin size={24} strokeWidth={2} />
        </span>
      </div>
      <div className="absolute bottom-4 left-4 right-4 flex flex-wrap items-center justify-between gap-2 rounded-2xl bg-white px-4 py-3 shadow-sm ring-1 ring-neutral-200 dark:bg-neutral-800 dark:ring-neutral-700 sm:right-auto">
        <div>
        ...
        <span className="rounded-full bg-[#8fa88f]/15 px-3 py-1 text-xs font-semibold text-[#6f8a6f]">Open until 6 PM</span>
      </div>
    </div>
  )
}
  ...
  return (
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-neutral-500 dark:text-neutral-400">Visit Us</p>
        ...
        <div className="mt-10 grid items-start gap-6 lg:grid-cols-5">
          ...
          <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-800 lg:col-span-2">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-7 inline-flex items-center gap-1.5 rounded-full border border-neutral-300 px-4 py-2.5 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-100 dark:border-neutral-600 dark:text-neutral-300 dark:hover:bg-white/5"
            >
              Get directions
            </a>
          </div>
