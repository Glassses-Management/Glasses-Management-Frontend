...
import AboutStandards from '@/pages/public/about/AboutStandards'
import AboutTechnology from '@/pages/public/about/AboutTechnology'
import AboutGuarantee from '@/pages/public/about/AboutGuarantee'
import AboutCredentials from '@/pages/public/about/AboutCredentials'
import AboutVisitStore from '@/pages/public/about/AboutVisitStore'
...
Optic Shop
      ...
      <section className="bg-white py-16 transition-colors duration-300 md:py-20 dark:bg-[#0E1A15]">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          ...
          <h2 data-aos="fade-up" className="mt-3 font-sans font-semibold text-4xl text-neutral-900 md:text-5xl dark:text-neutral-50">
            What We Do
          </h2>
          <div className="mt-4 h-[3px] w-12 rounded-full bg-forest" />
      ...
      <section className="bg-mist py-16 transition-colors duration-300 md:py-20 dark:bg-[#121F18]">
        <div className="mx-auto max-w-5xl px-4 md:px-6">
          <div className="grid items-center gap-8 rounded-3xl bg-white p-8 shadow-sm ring-1 ring-forest/20 md:grid-cols-[1fr_auto] md:p-12 dark:bg-[#16271F] dark:ring-leaf/20">
            ...
            <div data-aos="fade-right" className="flex h-16 w-16 items-center justify-center rounded-full bg-forest/10 text-forest dark:bg-leaf/10 dark:text-leaf">
