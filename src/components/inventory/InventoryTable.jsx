                ...
                <table className="w-full text-left text-sm">
                    <thead>
                        <tr className="bg-gray-50 dark:bg-white/5">
                            ...
                            <th className="px-5 py-4 text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-neutral-500">Cost Price</th>
                            <th className="px-5 py-4 text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-neutral-500">Sale Price</th>
                    ...
                    <tbody>
                        {products.map((p) => (
                            <tr key={p.id} className="border-b border-gray-100 transition-colors duration-300 last:border-b-0 hover:bg-gray-50 dark:border-neutral-800 dark:hover:bg-white/5">
                                ...
                                <td className="px-5 py-4 text-gray-500 dark:text-neutral-400">{formatCurrency(p.cost_price)}</td>
                                <td className="px-5 py-4 font-medium text-gray-900 dark:text-neutral-100">{formatCurrency(p.sale_price)}</td>
                                <td className="px-5 py-4">
