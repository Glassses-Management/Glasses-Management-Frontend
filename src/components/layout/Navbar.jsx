...
const pillBase =
  'inline-flex h-9 shrink-0 items-center justify-center whitespace-nowrap rounded-xl text-sm transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest focus-visible:ring-offset-2'
        ...
        <div className="col-start-3 ml-4 flex items-center justify-self-end gap-1.5">
          ...
          <div className="ml-2 hidden items-center gap-2 lg:flex">
            ...
            {authed ? (
              ...
              <>
                <button type="button" onClick={handleRequest} className={solid}>Request</button>
                <Link to="/login" state={{ from: path }} className={outline}>Sign In</Link>
              </>
            )}
          </div>
        ...
        <nav className="border-t border-neutral-200 bg-white px-4 py-3 dark:border-neutral-800 dark:bg-[#0E1A15] lg:hidden">
          ...
          <div className="mt-3 flex flex-col gap-1.5 border-t border-neutral-100 pt-3 dark:border-neutral-800">
            ...
            {authed ? (
              ...
              <Link to="/login" state={{ from: path }} onClick={() => setMenuOpen(false)} className={`${outline} w-full`}>Sign In</Link>
            )}
          </div>
        </nav>
      )}
